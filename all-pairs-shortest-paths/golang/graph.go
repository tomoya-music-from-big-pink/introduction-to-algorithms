...
func initializeSingleSource(g *Graph, s *Vertex) {
	vertices := g.vertices
...
func relax(u, v *Vertex, weight int) {
	if v.distance > u.distance+weight {
		fmt.Printf("relax: u = %s, v = %s / before = %d, after = %d\n", u.name, v.name, v.distance, u.distance+weight)
